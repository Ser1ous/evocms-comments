                    ...
                    columns: [
                        ...
                        { id:"id",	header:"Удалить",
                            template:function(obj){
                                return "<div class='webix_el_button'><button class='webixtype_base'> Удалить</button></div>";
                            }
                        }
                    ],
                    onClick:{
                        webixtype_base:function(ev, id, html){
                            webix.ajax("/manager/?a=112&id=5ba58db450ed04421f2a369e8eceb253&action=deleteComment&comment_id="+id);
                            this.remove(id);
                        }
                    },
